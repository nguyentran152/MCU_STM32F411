...
/*
 * This program generate PPL systems clock source using OscillatorType HSE
 */
...
//	SystemClockConfig_HSE(SYSCLK_CONF_FREQ_80MHz);
//	SystemClockConfig_HSE(SYSCLK_CONF_FREQ_100MHz);
